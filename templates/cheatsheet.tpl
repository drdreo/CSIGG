        ...
        <div class="box-body">
            <div class="col-md-6 border-right">
                ...
                <div class="col-md-12 visible-print">
                    ...
                    <div class="box no-border shadow" id="filePrintPreview"
                         style="padding: 5px; width:287.244094488px; height: 287.244094488px; word-wrap: break-word; overflow-wrap: break-word;">
                    </div>
                </div>
            </div>
            <div class="col-md-6 hidden-print">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3 col-xs-4 shadow" onclick="$('.sizeSelector').removeClass('sizeSelector');$(this).toggleClass('sizeSelector');"><span><b>Post It</b><br><small>76mm x 76mm</small></span>
                        </div>
                        <div class="col-md-3 col-xs-4 shadow" onclick="$('.sizeSelector').removeClass('sizeSelector');$(this).toggleClass('sizeSelector');"><span><b>Post It</b><br><small>76mm x 76mm</small></span>
                        </div>
                        <div class="col-md-6 col-xs-4 shadow" onclick="$('.sizeSelector').removeClass('sizeSelector');$(this).toggleClass('sizeSelector');"style="padding:5px;"><input class="form-control input-sm"
                                                                                 type="text"
